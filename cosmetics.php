...
<head>
    ...
    <title>Eye Vision | Cosmetics Related Eye Problems </title>
...
================================= -->
        ...
        <section class="animatedParent animateOnce subbanner subbanner-image subbanner-pattern-05 subbanner-type-2 subbanner-type-2-btn">
            <div class="container">
                <div class="subbanner-content banner-content">
                    <div class="skew-effect fadeInLeft animated">
                        <span class="fw-normal">EyeCare</span>
                    </div>
                            ...
                            <div class="clearfix">
                                <div class="sidebar-menu marbot40">
                                    <ul class="nav nav-tabs list-type2">
                                        <li><a href="computer_eyecare.php">Computer Related Eye Problems</a></li>
                                        <li><a href="diabetes.php">Diabetes Related Eye Problems</a></li>
                                        <li><a href="eye_checkup.php">Importance of Eye Check-up for Children</a></li>
                                        <li><a href="cosmetics.php">Cosmetics Related Eye Problems</a></li>
                                        <li><a href="myths.php">Common Eye Myths</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="clearfix">
                                <div class="tab-content animatedParent animateOnce">
                                    ...
                                    <!-- Tab 1 -->
                                    <div id="comprehensive" class="tab-pane active fadeInUp animated">
                                        <div class="row clearfix portfolio">
                                            <div class="col-md-12 marbot40">

                                                <a href="assets/images/square01.jpg" data-toggle="lightbox" data-gallery="about-gallery">
                                                    <div class="grid image-effect2 marbot30">
                                                        <figure>
                                                            <img src="assets/images/square01.jpg" alt=" " class="img-responsive fullwidth">
                                                            <figcaption><i class="fa flaticon-symbols-1 gallery-icon transition"></i></figcaption>
                                                        </figure>
                                                    </div>
                                                </a>
                                                <?php  
							 $sql = "select * from sub_computereyecare where sub_id=4";
							 $sql1 = "select * from eyecare where id=4";
							...
							{  
							 ...
							 ?>
                                                ...
                                                <p class="fontresize"><?php echo $content; ?>
                                                </p>
                                ...
                                {  
                                    $sheader=$row["sub_header"];
                                    $sid=$row["sub_id"];
                                    $scontent=$row["sub_content"];
                                       
                                 ?>
                                                <div class="panel-group accordion accordion-type1" id="accordion-services">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <a class="panel-title accordion-toggle collapsed" data-toggle="collapse" href="#<?php echo $i; ?>">
                                                                <?php echo $sheader; ?>
                                                            </a>
                                                        </div>
                                                        <div id="<?php echo $i; ?>" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <p class="fontresize"><?php echo $scontent; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Toggle Section 1 -->
